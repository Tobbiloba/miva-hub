...
export default async function AssignmentSubmissionPage({ params }: PageProps) {
  ...
  const assignmentData = await pgAcademicRepository.getStudentAssignmentById(
    userId,
    assignmentId,
  );
  ...
  const canSubmit =
    !isSubmitted && (assignment.allowLateSubmission || !isOverdue);
              ...
              <div className="flex items-center gap-2">
                ...
                {assignment.lateSubmissionPenalty && (
                  <Badge variant="outline">
                    {assignment.lateSubmissionPenalty}% penalty for late
                    submission
                  </Badge>
                )}
              </div>
                    ...
                    <div className="mt-2 p-4 border rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          {submission.fileSize && (
                            <p className="text-sm text-muted-foreground">
                              {(submission.fileSize / 1024 / 1024).toFixed(2)}{" "}
                              MB
                            </p>
                          )}
                        </div>
