                ...
                courses
                  ...
                  .map((courseData, index) => {
                    ...
                    return (
                      <div
                        key={course.id || index}
                        className="flex items-center justify-between p-3 border border-border/40 rounded-lg bg-muted/20"
                      >
              ...
              {userRole === "student" && upcomingAssignments.length > 0 ? (
                upcomingAssignments.slice(0, 4).map((assignmentData, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="flex items-start gap-3 p-3 border border-border/40 rounded-lg bg-muted/20"
                    >
                      <div
            ...
            <div className="grid gap-3 md:grid-cols-2">
              {students.slice(0, 6).map((studentData, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="flex items-center gap-3 p-3 border border-border/40 rounded-lg bg-muted/20"
                  >
                    <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center">
