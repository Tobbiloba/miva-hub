  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-3 gap-4 px-4 sm:px-6 md:px-8'>
      ...
      <div className='h-[280px] sm:h-[350px] md:h-[30rem] col-span-2 '>
        ...
        <h1 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-normal leading-tight'>Study smarter with Askly — your AI copilot for guides, quizzes, and citations</h1>
        <p className='text-neutral-200 font-[400] max-w-xl my-3 sm:my-4 text-sm sm:text-base md:text-lg'>Turn lectures and notes into study guides, create targeted quizzes in seconds, and get clear, cited explanations. Askly keeps all your study in one focused flow so you learn faster and remember longer.</p>
