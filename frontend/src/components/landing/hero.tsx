        ...
        <div className="container mx-auto relative z-10 h-full px-4 sm:px-6">
          ...
          <div className="flex-1 h-full flex flex-col justify-center items-start max-w-5xl pt-8 md:pt-0">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-normal leading-tight">
              Askly — your AI study copilot
            </h1>
            <p className="text-base sm:text-lg max-w-2xl text-neutral-300 py-4 sm:py-6 leading-relaxed">
              Ask questions about your courses and get instant answers with
              trusted sources. Generate comprehensive study guides from lecture
              notes, create targeted practice quizzes, and track your learning
              progress — all in one focused platform built for students who want
              to study smarter, not harder.
            </p>
            <Button className="mt-4 sm:mt-6 rounded gap-2 p-1.5 pl-4 sm:pl-6 h-fit hover:gap-3 transition-all text-sm sm:text-base">
              Try Askly free{" "}
              <div className="p-2 sm:p-3 bg-black text-white rounded">
