...
export const TOOLS_INFO_DATA: ToolInfo[] = [
  ...
  // ============================================
  {
    ...
    description:
      "Create interactive pie charts to visualize proportional data distribution",
  ...
  },
  {
    ...
    description:
      "Create line charts to show trends over time or continuous data",
    category: ToolCategory.Visualization,
    icon: "📈",
    demoVideoUrl: "",
  ...
  },
  {
    ...
    description:
      "Generate interactive flashcards for studying and memorization",
    category: ToolCategory.Visualization,
    icon: "🃏",
    demoVideoUrl: "",
    keywords: [
  ...
  },
  {
    ...
    displayName: "Quiz",
    description:
      "Create interactive quizzes to test knowledge and understanding",
    category: ToolCategory.Visualization,
    icon: "❓",
    demoVideoUrl: "",
    keywords: [
  ...
  },
  {
    ...
    displayName: "Exam",
    description:
      "Generate comprehensive exams with multiple question types and scoring",
    category: ToolCategory.Visualization,
    icon: "✏️",
    demoVideoUrl: "",
    keywords: [
  ...
  },
  {
    ...
    description:
      "Generate structured course materials, lessons, and educational content",
    category: ToolCategory.Visualization,
    icon: "📚",
    demoVideoUrl: "",
    keywords: [
  ...
  },
  {
    ...
    description:
      "Run Python code for data analysis, calculations, and automation",
    category: ToolCategory.CodeExecution,
    icon: "🐍",
    demoVideoUrl: "",
  ...
  // ============================================
  {
    ...
    description:
      "Retrieve course materials including lectures, readings, and resources",
  ...
  },
  {
    ...
    description:
      "View all upcoming assignments with due dates and requirements",
    category: ToolCategory.Academic,
    icon: "📋",
    demoVideoUrl: "",
