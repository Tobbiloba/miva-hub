...
export const createAssignmentTool = tool({
  description:
    "Create an interactive assignment preview with expandable sections and submission interface",
  inputSchema: z.object({
    ...
    instructions: z
      .string()
      .optional()
      .describe("Detailed instructions for the assignment"),
    rubric: z
      .array(
        z.object({
    ...
    resources: z
      .array(
        z.object({
          type: z
            .string()
            .describe("Type of resource (PDF, link, video, etc.)"),
