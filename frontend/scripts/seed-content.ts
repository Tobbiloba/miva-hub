...
async function resolveIds(client: pg.PoolClient) {
  ...
  for (const [key, email] of Object.entries(userMap)) {
    ...
    if (!id)
      throw new Error(
        `User not found: ${email} — run seed-demo-data and seed-students first`,
      );
    USERS[key] = id;
  }
  ...
  if (missing.length > 0) {
    throw new Error(
      `Courses not found: ${missing.join(", ")} — run seed-majors-and-courses and seed-demo-data first`,
    );
  }
...
async function upsert(
  ...
  // Check existence
  const whereClauses = uniqueCheck
...
const getAnnouncements = (): AnnouncementRow[] => [
  // University-wide
  {
    ...
    content:
      "Dear students, welcome back! The first semester commences on Monday 15 September 2025. Please check your course registrations and ensure all fees are settled before the end of week 1.",
    course_id: null,
  ...
  },
  {
    ...
    content:
      "Please note the mid-semester break runs from Monday 27 October to Sunday 2 November. No lectures or assessments will be scheduled during this period. Use this time to review and catch up on coursework.",
    course_id: null,
    created_by_id: USERS.admin,
    target_audience: "all",
    priority: "medium",
  ...
  },
  {
    ...
    content:
      "The university library management system will undergo scheduled maintenance on Saturday 18 October from 2:00 AM to 6:00 AM. Online catalogue and e-resources will be temporarily unavailable.",
    course_id: null,
    created_by_id: USERS.admin,
    target_audience: "all",
    priority: "medium",
  ...
  // Course-specific
  {
    ...
    content:
      "Programming Lab 1 (Hello World in Python) has been posted. Please submit via the portal before the deadline. Start early and visit office hours if you need help setting up your development environment.",
  ...
  },
  {
    ...
    content:
      "Please complete the reading for Chapters 1–3 of the Rosen textbook (Sets, Logic, and Proofs) before our next lecture. We will have a short in-class quiz on the material.",
  ...
  },
  {
    ...
    content:
      "Due to a scheduling conflict with the Engineering building, the Digital Logic Design lab session originally on Thursday has been moved to Tuesday 14:00–16:00 in Room ENG-204. Please update your schedules.",
  ...
  },
  {
    ...
    content:
      "Additional practice problems for linear algebra (matrix operations and determinants) have been uploaded to the course materials section. These are not graded but strongly recommended for exam preparation.",
  ...
  },
  {
    ...
    content:
      "The Department of General Studies is organising a Cultural Day celebration on Friday 24 October. Students are encouraged to represent their cultural heritage through dress, food, or performance. Participation counts towards class engagement.",
  ...
  },
  {
    ...
    content:
      "An optional revision class will be held on Saturday at 10:00 AM in Lecture Hall 3 to go over matrix transformations. Bring your problem sets.",
    course_id: COURSES.MTH201,
    created_by_id: USERS.funke,
    target_audience: "course_specific",
    priority: "medium",
  ...
  },
  {
    ...
    content:
      "Dr. Emeka Nwosu from CypherCrescent will deliver a guest lecture on AI applications in software engineering this Wednesday at 2 PM in the CS auditorium. Attendance is optional but highly encouraged for all CS students.",
    course_id: COURSES.COS201,
    created_by_id: USERS.adebayo,
    target_audience: "course_specific",
    priority: "medium",
...
const getAssignments = (): AssignmentRow[] => [
  // COS201
  {
    ...
    description:
      "Write a Python program that greets the user by name, performs basic arithmetic, and demonstrates string formatting.",
    instructions:
  ...
  },
  {
    ...
    description:
      "Build a simple calculator that handles integer and floating-point arithmetic with proper error handling.",
    instructions:
  ...
  // COS203
  {
    ...
    description:
      "Problem set covering propositional logic, truth tables, and logical equivalences from Chapters 1–2.",
    instructions:
      "Answer all 10 questions. Show all working clearly. For truth tables, include all intermediate columns. For proofs, state the rule applied at each step. Handwritten submissions must be legible; typed submissions preferred.",
  ...
  },
  {
    ...
    description:
      "Construct truth tables for compound propositions and determine logical equivalences.",
    instructions:
      "For each of the 8 propositions provided, construct a complete truth table. Identify which pairs are logically equivalent. Bonus: express each in CNF and DNF form.",
    assignment_type: "homework",
    total_points: 50,
  ...
  // COS205
  {
    ...
    description:
      "Design and simulate basic logic gate circuits (AND, OR, NOT, NAND, XOR) using Logisim and submit a lab report.",
    instructions:
  ...
  // MTH201
  {
    ...
    description:
      "Exercises on matrix operations, determinants, and systems of linear equations.",
    instructions:
      "Solve all 12 problems from the worksheet. Show complete working for each problem. For matrix operations, write out each step. For systems of equations, use both Gaussian elimination and Cramer's rule where applicable.",
    assignment_type: "homework",
    total_points: 100,
    due_date: daysAgo(7),
    submission_type: "file_upload",
  ...
  },
  {
    ...
    description:
      "Timed quiz on matrix multiplication, transposition, and inverse computation.",
    instructions:
      "This is a 45-minute timed quiz. Answer all 6 questions. No calculators allowed. You may use one A4 sheet of handwritten notes. Submit your answer sheet as a scanned PDF.",
  ...
  // GST112
  {
    ...
    description:
      "Write a 1500-word essay exploring the role of cultural diversity in shaping Nigeria's national identity.",
    instructions:
  ...
  // 100L courses for Bisi
  {
    ...
    description:
      "Write a 500-word essay on the history and evolution of computing, from Babbage to modern cloud computing.",
    instructions:
      "Cover at least 4 major milestones in computing history. Include proper citations. Submit as PDF.",
    assignment_type: "essay",
    total_points: 50,
  ...
  },
  {
    ...
    description:
      "Exercises on polynomials, inequalities, and basic set theory from Chapters 1–2.",
    instructions:
      "Solve all 15 problems. Show full working. For set problems, use Venn diagrams where appropriate.",
    assignment_type: "homework",
    total_points: 100,
  ...
  },
  {
    ...
    description:
      "Design an Entity-Relationship diagram for a university course management system.",
    instructions:
      "1. Identify at least 8 entities with attributes\n2. Define relationships with cardinality\n3. Normalise to 3NF\n4. Use standard ER notation\n5. Submit as PDF (hand-drawn or software-generated).",
    assignment_type: "homework",
    total_points: 100,
...
const getSubmissions = (): SubmissionSpec[] => [
  // Ada — COS201 Lab 1 (graded)
  {
    ...
    file_url:
      "s3://miva-university-content/submissions/ada-okonkwo/cos201-lab1-hello-world.zip",
    file_name: "cos201-lab1-hello-world.zip",
    file_size: 24576,
    mime_type: "application/zip",
    grade: 92,
    feedback:
      "Excellent work! Well-commented code and proper structure. Your string formatting examples were creative. Minor: consider using f-strings consistently instead of mixing .format() and %.",
  ...
  // Ada — COS203 Problem Set 1 (graded)
  {
    ...
    submission_text: null,
    file_url:
      "s3://miva-university-content/submissions/ada-okonkwo/cos203-pset1-logic.pdf",
    file_name: "cos203-pset1-logic.pdf",
    file_size: 512000,
    mime_type: "application/pdf",
    grade: 85,
    feedback:
      "Good effort overall. Your truth tables are correct. Review the proof technique for logical equivalence in section 2.3 — you used an informal argument where a formal derivation was expected. Questions 7 and 9 had minor errors.",
    is_late_submission: false,
  ...
  // Ada — MTH201 Problem Set 1 (graded)
  {
    ...
    submission_text: null,
    file_url:
      "s3://miva-university-content/submissions/ada-okonkwo/mth201-pset1-matrices.pdf",
    file_name: "mth201-pset1-matrices.pdf",
    file_size: 384000,
    mime_type: "application/pdf",
    grade: 78,
    feedback:
      "Decent work. Watch out for sign errors in matrix operations — you lost marks on Q4 and Q8 due to arithmetic mistakes in determinant calculations. Your Gaussian elimination steps are well laid out. Review Cramer's rule for 4×4 systems.",
    is_late_submission: false,
  ...
  // Ada — COS201 Lab 2 (submitted, pending)
  {
    ...
    submission_text: null,
    file_url:
      "s3://miva-university-content/submissions/ada-okonkwo/cos201-lab2-calculator.zip",
  ...
  // Ada — COS203 Truth Tables (submitted, pending)
  {
    ...
    submission_text: null,
    file_url:
      "s3://miva-university-content/submissions/ada-okonkwo/cos203-truth-tables.pdf",
  ...
  // Chidi — COS301 Divide and Conquer (submitted, pending)
  {
    ...
    submission_text: null,
    file_url:
      "s3://miva-university-content/submissions/chidi-okeke/cos301-divide-conquer.zip",
  ...
  // Chidi — COS303 ER Diagram (submitted, pending)
  {
    ...
    submission_text: null,
    file_url:
      "s3://miva-university-content/submissions/chidi-okeke/cos303-er-diagram.pdf",
...
const getMaterials = (): MaterialRow[] => [
  // ── COS201: Computer Programming I ──
  {
    ...
    description:
      "Comprehensive 4-hour video covering Python basics, variables, data types, control flow, and functions. Watch sections 1–3 for weeks 1–2.",
  ...
  },
  {
    ...
    description:
      "Harvard CS50 introductory lecture covering computational thinking, algorithms, and pseudocode. Good foundation before diving into Python.",
  ...
  },
  {
    ...
    description:
      "Open-access textbook by Allen B. Downey. Covers values, variables, statements, functions, and interface design. Required reading for weeks 1–3.",
  ...
  },
  {
    ...
    description:
      "Complete course outline including weekly topics, assessment breakdown, office hours, and required textbooks.",
    content_url:
      "s3://miva-university-content/syllabi/cos201-syllabus-2025-2026.pdf",
    public_url: null,
  ...
  // ── COS203: Discrete Structures ──
  {
    ...
    description:
      "MIT 6.042J Mathematics for Computer Science. Covers proofs, induction, and number theory. Excellent supplement to the Rosen textbook.",
  ...
  },
  {
    ...
    description:
      "Clear walkthrough of constructing truth tables for compound propositions and verifying logical equivalences. Directly relevant to Problem Set 1.",
  ...
  },
  {
    ...
    material_type: "reading",
    title:
      "Discrete Mathematics and Its Applications (Rosen) – Chapter 1 Summary",
    description:
      "Professor-curated summary notes for Chapter 1: The Foundations — Logic and Proofs. Print-friendly PDF.",
  ...
  },
  {
    ...
    description:
      "Supplementary PDF covering proof techniques: direct, contrapositive, contradiction, and induction. Useful reference for all coursework.",
    content_url:
  ...
  },
  {
    ...
    description:
      "Course outline covering sets, logic, proofs, relations, functions, counting, and graph theory. Includes assessment scheme.",
    content_url:
      "s3://miva-university-content/syllabi/cos203-syllabus-2025-2026.pdf",
    public_url: null,
  ...
  // ── COS205: Digital Logic Design ──
  {
    ...
    description:
      "Video series on Boolean algebra fundamentals, logic gates, and simplification using Karnaugh maps. Covers weeks 1–4 of the course.",
  ...
  },
  {
    ...
    description:
      "Project-based course building a modern computer from first principles. Excellent companion to the lab component of COS205.",
  ...
  },
  {
    ...
    description:
      "Official documentation for the Logisim circuit simulator. Required for lab assignments — install before the first lab session.",
    content_url:
  ...
  },
  {
    ...
    description:
      "Course outline covering number systems, Boolean algebra, logic gates, combinational circuits, sequential circuits, and memory elements.",
    content_url:
      "s3://miva-university-content/syllabi/cos205-syllabus-2025-2026.pdf",
    public_url: null,
  ...
  // ── MTH201: Mathematical Methods I ──
  {
    ...
    description:
      "Beautiful visual series on vectors, linear transformations, matrices, determinants, and eigenvalues. Highly recommended for building intuition.",
  ...
  },
  {
    ...
    description:
      "Step-by-step walkthrough of matrix multiplication with worked examples. Good refresher before attempting Problem Set 1.",
  ...
  },
  {
    ...
    description:
      "Open-source textbook covering linear systems, vector spaces, and maps between spaces. Chapters 1–2 align with weeks 1–4 of this course.",
  ...
  },
  {
    ...
    description:
      "Additional practice problems on matrix operations, determinants, and linear systems. Not graded but strongly recommended for exam preparation.",
    content_url:
      "s3://miva-university-content/resources/mth201-practice-w1-w2.pdf",
    public_url: null,
  ...
  },
  {
    ...
    description:
      "Course outline covering real analysis, linear algebra, vector calculus, and ordinary differential equations. Includes grading rubric.",
    content_url:
      "s3://miva-university-content/syllabi/mth201-syllabus-2025-2026.pdf",
    public_url: null,
  ...
  // ── GST112: Nigerian People and Culture ──
  {
    ...
    description:
      "Documentary exploring Nigeria's diverse cultural landscape, covering the major ethnic groups, traditions, festivals, and their significance in modern Nigeria.",
  ...
  },
  {
    ...
    description:
      "Comprehensive reference on Nigeria's history, society, economy, and culture. Chapters on ethnic groups and cultural institutions are most relevant.",
  ...
  },
  {
    ...
    description:
      "Guide to academic essay writing with examples of proper APA citation format. Essential reading before the Cultural Diversity essay assignment.",
  ...
  },
  {
    ...
    description:
      "Course outline covering Nigerian peoples, cultural practices, national integration, citizenship, and inter-group relations.",
    content_url:
      "s3://miva-university-content/syllabi/gst112-syllabus-2025-2026.pdf",
    public_url: null,
...
async function main() {
  ...
  try {
    ...
    console.log(
      `Announcements: ${announcementsCreated} upserted (${ANNOUNCEMENTS.length} defined)`,
    );
    ...
    console.log(
      `Assignments: ${assignmentsCreated} upserted (${ASSIGNMENTS.length} defined)`,
    );
    ...
    for (const s of SUBMISSIONS) {
      ...
      if (!assignmentId) {
        console.warn(
          `  ⚠ Assignment not found for submission: ${s.assignment_title}`,
        );
        continue;
      }
    ...
    console.log(
      `Submissions: ${submissionsCreated} upserted (${SUBMISSIONS.length} defined)`,
    );
    ...
    console.log(
      `Materials: ${materialsCreated} upserted (${MATERIALS.length} defined)`,
    );
