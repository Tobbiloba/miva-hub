...
async function main() {
  ...
  const connectionString =
    "postgresql://neondb_owner:npg_yHvJxWwdLI06@ep-polished-bush-a4rlilp8-pooler.us-east-1.aws.neon.tech/neondb?sslmode=require";
  ...
  console.log(
    `Individual Params (Port 5432): ${test2Success ? "✓ SUCCESS" : "✗ FAILED"}`,
  );
  console.log(
    `Individual Params (Port 3306): ${test3Success ? "✓ SUCCESS" : "✗ FAILED"}`,
  );
  ...
  console.log(
    "- The individual parameters you provided use port 3306 (MySQL port)",
  );
