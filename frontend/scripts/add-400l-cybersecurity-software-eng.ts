...
async function add400LCybersecurityAndSoftwareEngCourses() {
  try {
    console.log(
      "🎓 Adding 400L Cybersecurity and Software Engineering courses...",
    );
    ...
    const cyb400LCourses = [
      ...
      {
        courseCode: "CYB407",
        title: "Information Security and Data Management",
        level: "400L",
        semester: "fall",
      },
      // 2nd Semester
      {
        courseCode: "CYB408",
        title: "Ethics and Legal Issues in Cyber Security",
        level: "400L",
        semester: "spring",
      },
      {
    ...
    const sen400LCourses = [
      ...
      {
        courseCode: "SEN408",
        title: "Ethics and Legal Issues in Software Engineering",
        level: "400L",
        semester: "spring",
      },
      {
    ...
    console.log(
      `✅ Added ${createdCybCourses.length} 400L Cybersecurity courses`,
    );
    ...
    console.log(
      `✅ Added ${createdSenCourses.length} 400L Software Engineering courses`,
    );
