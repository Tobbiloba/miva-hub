  ...
  try {
    ...
    const programsData = [
      // Computing
      {
        ...
        description:
          "Study of computation, algorithms, and software development",
      },
      {
        code: "CYB",
        name: "Cybersecurity",
      ...
      },
      {
        ...
        name: "Data Science",
        description:
          "Big data analytics, machine learning, and data visualization",
      },
      {
        code: "SEN",
    ...
    const existingPrograms = await db
      .select({ code: ProgramSchema.code })
      .from(ProgramSchema);
    ...
    console.log(
      `   (${existingCodes.size} already existed, ${programsData.length - toInsert.length - programs.length} skipped)`,
    );
