...
async function testConnection() {
  ...
  const connectionString =
    "postgresql://neondb_owner:npg_qEo2tSb7HNIC@ep-ancient-scene-adjqsmnu-pooler.c-2.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require";

  console.log("Testing ACTUAL database connection from .env file\n");
  console.log("=".repeat(60));
  console.log(
    "Hostname: ep-ancient-scene-adjqsmnu-pooler.c-2.us-east-1.aws.neon.tech",
  );
